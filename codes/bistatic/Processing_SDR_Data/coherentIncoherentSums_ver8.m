...
function [coherentSumReturned,incoherentSumReturned,numChirpsDetected,noChirpsFiles] = coherentIncoherentSums_ver8(ref_chirp,fs,directory,windowSize,dataType,numPhaseShifts,phaseRange,display)
